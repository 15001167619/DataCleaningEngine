...
import com.binggou.engine.modules.service.IDataEngineJobService;
 ...
 */
@Service("dataEngineJobService")
public class DataEngineJobServiceImpl  implements IDataEngineJobService {
    ...
    public List<QuartzEntity> listQuartzEntity(QuartzEntity quartz, Integer pageNo, Integer pageSize) {
        ...
        return dynamicQueryService.nativeQueryListModel(QuartzEntity.class, nativeSql.toString(),params);
    }
    ...
    public Long listQuartzEntity(QuartzEntity quartz) {
        ...
        nativeSql.append("LEFT JOIN qrtz_cron_triggers AS cron ON cron.TRIGGER_NAME = tri.TRIGGER_NAME ");
        nativeSql.append("WHERE tri.TRIGGER_TYPE = 'CRON'");
        return dynamicQueryService.nativeQueryCount(nativeSql.toString(), new Object[]{});
    }
}
